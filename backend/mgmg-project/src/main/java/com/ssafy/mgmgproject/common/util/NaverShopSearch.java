...
public class NaverShopSearch {
    ...
    public String search(String query) {
        ...
        ResponseEntity<String> responseEntity = rest.exchange("https://openapi.naver.com/v1/search/shop.json?query=" + query + "&display=30", HttpMethod.GET, requestEntity, String.class);
